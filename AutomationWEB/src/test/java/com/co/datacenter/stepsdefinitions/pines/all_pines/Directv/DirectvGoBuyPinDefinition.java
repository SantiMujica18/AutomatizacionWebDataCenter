package com.co.datacenter.stepsdefinitions.pines.all_pines.Directv;
...
import com.co.datacenter.tasks.pines.select_pines.SelectDirectvPinTask;
...
public class DirectvGoBuyPinDefinition {
    ...
    public void iSelectDirectvGoPinAndFillAllTheForm() {
        Sebas.wasAbleTo(
