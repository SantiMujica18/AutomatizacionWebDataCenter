package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_claro_recharge;
...
public class ConfirmClaroRechargeDefinition {
    ...
    public void userWantsToMakeAClaroRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on(),
