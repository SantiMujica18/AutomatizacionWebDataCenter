package com.co.datacenter.stepsdefinitions.pines.all_pines.Imvu;
...
import com.co.datacenter.tasks.pines.select_pines.SelectImvuPinTask;
...
public class ImvuBuyPinDefinition {
    ...
    public void iSelectImvuPinAndFillAllTheForm() {
        Sebas.wasAbleTo(
