package com.co.datacenter.stepsdefinitions.pines.all_pines.Spotify;
...
import com.co.datacenter.tasks.pines.select_pines.SelectSpotifyPinTask;
...
public class SpotifyBuyPinDefinition {
    ...
    public void iSelectSpotifyPinAndFillAllTheForm() {
        Sebas.wasAbleTo(
