package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_unicorn_recharge;
...
import com.co.datacenter.tasks.recharge.select_recharge.SelectUnicornRechargeTask;
...
public class ConfirmUnicornRechargeDefinition {
    ...
    public void userWantsToMakeAUnicornRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on(),
