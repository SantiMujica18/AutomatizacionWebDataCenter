package com.co.datacenter.stepsdefinitions.chance_tradicional.flujo_aleatorio;
...
public class ValidationChanceTradicionalAleatorioDefinition {
    ...
    public void elUsuarioSeleccionaElNumeroAleatorioTresCifras() {
        User.wasAbleTo(
                SeleccionarTresCifrasTask.on()
        );
    }
