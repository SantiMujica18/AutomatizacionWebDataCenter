package com.co.datacenter.stepsdefinitions.pines.all_pines.Rixty;
...
import com.co.datacenter.tasks.pines.select_pines.SelectRixtyPinTask;
...
public class RixtyBuyPinDefinition {
    ...
    @When("^I select Rixty pin and fill all the form$")
    public void iSelectRixtyPinAndFillAllTheForm() {
        Sebas.wasAbleTo(
