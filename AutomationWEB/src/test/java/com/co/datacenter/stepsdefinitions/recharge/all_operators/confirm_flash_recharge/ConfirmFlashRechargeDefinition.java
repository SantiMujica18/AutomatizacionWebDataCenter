package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_flash_recharge;
...
import com.co.datacenter.tasks.recharge.select_recharge.SelectFlashRechargeTask;
...
public class ConfirmFlashRechargeDefinition {
    ...
    public void userWantsToMakeAFlashRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on(),
