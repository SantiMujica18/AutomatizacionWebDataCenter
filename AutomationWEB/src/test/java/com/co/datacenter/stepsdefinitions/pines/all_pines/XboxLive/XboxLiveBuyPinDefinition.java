package com.co.datacenter.stepsdefinitions.pines.all_pines.XboxLive;
...
import com.co.datacenter.tasks.pines.select_pines.SelectXboxLivePinTask;
...
public class XboxLiveBuyPinDefinition {
    ...
    public void iSelectXboxLivePinAndFillAllTheForm() {
        Sebas.wasAbleTo(
