package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_wom_recharge;
...
import com.co.datacenter.tasks.recharge.select_recharge.SelectWomRechargeTask;
...
public class ConfirmWomRechargeDefinition {
    ...
    public void userWantsToMakeAWomRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on(),
