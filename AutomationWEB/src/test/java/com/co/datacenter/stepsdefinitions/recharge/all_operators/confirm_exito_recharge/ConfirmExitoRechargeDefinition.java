package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_exito_recharge;
...
import com.co.datacenter.tasks.recharge.select_recharge.SelectExitoRechargeTask;
...
public class ConfirmExitoRechargeDefinition {
    ...
    public void userWantsToMakeAExitoRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on()
        );
