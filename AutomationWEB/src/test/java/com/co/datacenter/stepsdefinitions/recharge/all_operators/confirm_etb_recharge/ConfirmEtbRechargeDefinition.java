package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_etb_recharge;
...
import com.co.datacenter.tasks.recharge.select_recharge.SelectEtbRechargeTask;
...
public class ConfirmEtbRechargeDefinition {
    ...
    public void userWantsToMakeAEtbRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on(),
