package com.co.datacenter.stepsdefinitions.pines.all_pines.Microsoft;
...
import com.co.datacenter.tasks.pines.select_pines.SelectMicrosoftPinTask;
...
public class MicrosoftBuyPinDefinition {
    ...
    @When("^I select Microsoft (\\d+) pin and fill all the form$")
    public void iSelectMicrosoftPinAndFillAllTheForm(int arg1) {
        Sebas.wasAbleTo(
