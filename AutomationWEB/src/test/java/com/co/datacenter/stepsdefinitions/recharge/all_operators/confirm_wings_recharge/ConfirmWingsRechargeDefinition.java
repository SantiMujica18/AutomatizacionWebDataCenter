package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_wings_recharge;
...
import com.co.datacenter.tasks.recharge.select_recharge.SelectWingsRechargeTask;
...
public class ConfirmWingsRechargeDefinition {
    ...
    public void userWantsToMakeAWingsRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on(),
