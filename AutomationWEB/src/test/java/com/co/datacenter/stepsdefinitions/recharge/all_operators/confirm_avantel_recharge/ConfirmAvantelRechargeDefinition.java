package com.co.datacenter.stepsdefinitions.recharge.all_operators.confirm_avantel_recharge;
...
import com.co.datacenter.tasks.recharge.select_recharge.SelectAvantelRechargeTask;
...
public class ConfirmAvantelRechargeDefinition {
    ...
    public void userWantsToMakeAAvantelRecharge() {
        User.wasAbleTo(
                OpenThePage.on(),
                LoginUserTask.on(),
