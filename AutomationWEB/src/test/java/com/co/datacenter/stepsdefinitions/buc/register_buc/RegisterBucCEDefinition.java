...
public class RegisterBucCEDefinition {
    ...
    public void userIsOnBucRegistrationLandingPage() {
        user.wasAbleTo(
    ...
    public void youFillOutTheBucFormWithYourDataCE() {
        user.wasAbleTo(
    ...
    public void theUserIsRegisteredWithHisCE() {
