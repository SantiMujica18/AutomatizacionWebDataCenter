package com.co.datacenter.stepsdefinitions.pines.all_pines.RazerGold;
...
import com.co.datacenter.tasks.pines.select_pines.SelectRazerGoldPinTask;
...
public class RazerGoldBuyPinDefinition {
    ...
    public void iSelectRazerGoldPinAndFillAllTheForm() {
        Sebas.wasAbleTo(
