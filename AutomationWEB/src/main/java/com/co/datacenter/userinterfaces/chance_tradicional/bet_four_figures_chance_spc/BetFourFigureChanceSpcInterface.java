...
//div[@id="mainForm:opt_22500"]
    ...
    public static Target CHECK_BOX_BALANCE_PAY = Target.the("check box de saldo de pago").
            located(By.xpath("//div[@id=\"mainForm:opt__1\"]"));
    ...
    public static Target BTN_ACCEPT_PAY = Target.the("Boton para aceptar pago exitoso")
            .locatedBy("//button[@id='mainForm:j_idt417']");
    public static Target NAV_APUESTA = Target.the("Servicio de apuesta nav")
            .locatedBy("//li[@id='menuform:sm_inicio']");
