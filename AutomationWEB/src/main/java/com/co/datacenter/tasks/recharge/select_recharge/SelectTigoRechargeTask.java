...
public class SelectTigoRechargeTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                WaitUntil.the(SelectOperatorInterface.TIGO, isVisible()),
                Click.on(SelectOperatorInterface.TIGO)
        );
    ...
    public static SelectTigoRechargeTask on(){
        return instrumented(SelectTigoRechargeTask.class);
    }
}
