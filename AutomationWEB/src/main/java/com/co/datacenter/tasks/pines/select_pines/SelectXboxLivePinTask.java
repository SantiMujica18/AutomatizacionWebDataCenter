...
public class SelectXboxLivePinTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(DataPaymentPinesInterface.XBOXLIVE_PRODUCT, isVisible()),
                Click.on(DataPaymentPinesInterface.XBOXLIVE_PRODUCT)
        );


    }

    public static SelectXboxLivePinTask on(){return instrumented(SelectXboxLivePinTask.class);}
