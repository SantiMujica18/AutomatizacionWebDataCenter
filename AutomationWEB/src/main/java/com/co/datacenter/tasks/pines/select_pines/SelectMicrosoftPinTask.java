...
public class SelectMicrosoftPinTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(DataPaymentPinesInterface.MICROSOFT365_PRODUCT, isVisible()),
                Click.on(DataPaymentPinesInterface.MICROSOFT365_PRODUCT)
        );


    }

    public static SelectMicrosoftPinTask on(){return instrumented(SelectMicrosoftPinTask.class);}
