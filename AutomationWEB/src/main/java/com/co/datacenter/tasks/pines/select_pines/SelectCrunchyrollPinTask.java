...
public class SelectCrunchyrollPinTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(DataPaymentPinesInterface.CRUNCHYROLL_PRODUCT, isVisible()),
                Click.on(DataPaymentPinesInterface.CRUNCHYROLL_PRODUCT)
    ...
    public static SelectCrunchyrollPinTask on(){return instrumented(SelectCrunchyrollPinTask.class);}
