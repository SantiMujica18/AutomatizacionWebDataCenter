...
public class LoginUserBucCETask implements Task {
    ...
    public <T extends Actor> void performAs(T actor){
        ...
        actor.attemptsTo(
                ...
                Enter.theValue("C").into(HomePageBUCInterfaces.DOCUMENT_TYPE),
                Delay.ofMilliseconds(100),
                Click.on(HomePageBUCInterfaces.CITIZENSHIP_CARD_CE),
    ...
    public static LoginUserBucCETask on() {
        return instrumented(LoginUserBucCETask.class);
    }
