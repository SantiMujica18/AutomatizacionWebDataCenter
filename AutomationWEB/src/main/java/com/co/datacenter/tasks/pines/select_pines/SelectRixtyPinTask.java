...
public class SelectRixtyPinTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(DataPaymentPinesInterface.RIXTY_PRODUCT, isVisible()),
                Click.on(DataPaymentPinesInterface.RIXTY_PRODUCT)
        );


    }

    public static SelectRixtyPinTask on(){return instrumented(SelectRixtyPinTask.class);}
