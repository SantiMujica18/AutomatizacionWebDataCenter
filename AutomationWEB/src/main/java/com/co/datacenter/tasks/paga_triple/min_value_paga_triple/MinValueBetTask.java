package com.co.datacenter.tasks.paga_triple.min_value_paga_triple;
...
public class MinValueBetTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitUntil.the(BetTPagaTripleInterFaces.SELECT_MIN_VALUE, isVisible()),
                Click.on(BetTPagaTripleInterFaces.SELECT_MIN_VALUE),
                Delay.ofMilliseconds(500),
    ...
    public static MinValueBetTask on() {
        return instrumented(MinValueBetTask.class);
    }
