...
public class LoginUserBucPEDPTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor){
        actor.attemptsTo(
                ...
                Click.on(HomePageBUCInterfaces.CITIZENSHIP_CARD_PEDP),
    ...
    public static LoginUserBucPEDPTask on(){
        return instrumented(LoginUserBucPEDPTask.class);
    }
}
