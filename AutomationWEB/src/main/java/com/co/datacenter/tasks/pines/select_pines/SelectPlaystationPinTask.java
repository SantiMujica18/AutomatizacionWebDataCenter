...
public class SelectPlaystationPinTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(DataPaymentPinesInterface.PLAYSTATION_PRODUCT, isVisible()),
                Click.on(DataPaymentPinesInterface.PLAYSTATION_PRODUCT)
        );


    }

    public static SelectPlaystationPinTask on(){return instrumented(SelectPlaystationPinTask.class);}
