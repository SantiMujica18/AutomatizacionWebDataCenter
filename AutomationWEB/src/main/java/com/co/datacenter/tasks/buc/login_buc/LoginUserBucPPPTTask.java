...
public class LoginUserBucPPPTTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(HomePageBUCInterfaces.CITIZENSHIP_CARD_PPPT),
    ...
    public static LoginUserBucPPPTTask on(){return instrumented(LoginUserBucPPPTTask.class);}
}
