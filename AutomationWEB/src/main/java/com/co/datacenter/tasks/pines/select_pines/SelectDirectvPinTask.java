...
public class SelectDirectvPinTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(DataPaymentPinesInterface.DIRECTVGO_PRODUCT, isVisible()),
                Click.on(DataPaymentPinesInterface.DIRECTVGO_PRODUCT)
        );
    }

    public static SelectDirectvPinTask on(){return instrumented(SelectDirectvPinTask.class);}
